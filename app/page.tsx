...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="card-purple-border hover-scale">
              <CardContent className="p-8">
                ...
                <h4 className="text-xl font-bold mb-3 text-primary">Conception/refonte de sites web</h4>
      ...
      {/* About Section */}
      <section id="à-propos" className="section-padding bg-gradient-primary text-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      ...
      <section id="avis" className="section-padding bg-gradient-subtle">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-6xl md:text-7xl font-bold mb-6">
